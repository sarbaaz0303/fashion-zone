...
export default function Component() {
  ...
  return (
    <aside
      className={`fixed top-0 left-0 z-40 h-screen shrink-0 border-r border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-950 ${
    ...
    >
      <div className="flex h-16 items-center justify-between px-4">
        <Link href="#" className="flex items-center gap-2" prefetch={false}>
          ...
          <span className={`text-lg font-semibold ${isExpanded ? "block" : "hidden"}`}>Acme Inc</span>
        </Link>
        <Button variant="outline" size="icon" className="lg:hidden" onClick={() => setIsExpanded(!isExpanded)}>
          <ChevronLeftIcon className="h-6 w-6" />
          <span className="sr-only">Toggle navigation</span>
        </Button>
      </div>
      <div className={`h-[calc(100vh-4rem)] overflow-y-auto px-4 py-6 ${isExpanded ? "block" : "hidden"}`}>
          ...
          <Collapsible className="space-y-1">
            <CollapsibleTrigger className="flex items-center justify-between gap-3 rounded-md px-3 py-2 text-sm font-medium text-gray-500 transition-all hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-50">
              <div className="flex items-center gap-3">
                ...
                <span className={`${isExpanded ? "block" : "hidden"}`}>Applications</span>
              </div>
            ...
            <CollapsibleContent className="space-y-1 pl-6">
              ...
              >
                ...
                <span className={`${isExpanded ? "block" : "hidden"}`}>Inbox</span>
              </Link>
              <Link
                href="#"
                className="flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium text-gray-500 transition-all hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-50"
              ...
              >
                ...
                <span className={`${isExpanded ? "block" : "hidden"}`}>Chat</span>
              </Link>
              <Link
                href="#"
                className="flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium text-gray-500 transition-all hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-50"
              ...
              >
                ...
                <span className={`${isExpanded ? "block" : "hidden"}`}>Kanban</span>
              </Link>
              <Link
                href="#"
                className="flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium text-gray-500 transition-all hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-50"
              ...
              >
                ...
                <span className={`${isExpanded ? "block" : "hidden"}`}>Files</span>
              </Link>
            </CollapsibleContent>
          </Collapsible>
          <Collapsible className="space-y-1">
            ...
            <CollapsibleContent className="space-y-1 pl-6">
              ...
              >
                ...
                <span className={`${isExpanded ? "block" : "hidden"}`}>Security</span>
              </Link>
              <Link
                href="#"
                className="flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium text-gray-500 transition-all hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-50"
              ...
              >
                ...
                <span className={`${isExpanded ? "block" : "hidden"}`}>Notifications</span>
              </Link>
              <Link
                href="#"
                className="flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium text-gray-500 transition-all hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-50"
              ...
              >
                ...
                <span className={`${isExpanded ? "block" : "hidden"}`}>Integrations</span>
              </Link>
              <Link
                href="#"
                className="flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium text-gray-500 transition-all hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-50"
              ...
              >
                ...
                <span className={`${isExpanded ? "block" : "hidden"}`}>Billing</span>
              </Link>
            </CollapsibleContent>
          </Collapsible>
          <Link
